...
import static net.runelite.client.plugins.hd.HdPlugin.ORTHOGRAPHIC_ZOOM;
...
import static net.runelite.client.plugins.hd.utils.HDUtils.getSceneBaseExtended;
