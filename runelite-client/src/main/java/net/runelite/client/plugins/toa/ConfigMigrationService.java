...
import static net.runelite.client.plugins.toa.TombsOfAmascutConfig.CONFIG_GROUP;
import static net.runelite.client.plugins.toa.TombsOfAmascutConfig.KEY_HET_PICKAXE_MENU_SWAP;
import static net.runelite.client.plugins.toa.TombsOfAmascutConfig.KEY_HET_PICKAXE_PREVENT_EXIT;
import static net.runelite.client.plugins.toa.TombsOfAmascutConfig.KEY_HP_ORB_MODE;
import static net.runelite.client.plugins.toa.TombsOfAmascutConfig.KEY_QUICK_PROCEED_ENABLE_MODE;
import net.runelite.client.plugins.toa.features.QuickProceedSwaps;
import net.runelite.client.plugins.toa.features.het.pickaxe.DepositPickaxeMode;
import net.runelite.client.plugins.toa.features.hporbs.HpOrbMode;
