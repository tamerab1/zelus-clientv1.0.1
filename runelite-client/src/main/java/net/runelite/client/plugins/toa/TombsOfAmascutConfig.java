...
import net.runelite.client.plugins.toa.features.QuickProceedSwaps.QuickProceedEnableMode;
...
import net.runelite.client.plugins.toa.features.scabaras.overlay.MatchingTileDisplayMode;
import net.runelite.client.plugins.toa.features.timetracking.SplitsMode;
import net.runelite.client.plugins.toa.features.updatenotifier.UpdateNotifier;
import net.runelite.client.plugins.toa.util.FontStyle;
import net.runelite.client.plugins.toa.util.HighlightMode;
